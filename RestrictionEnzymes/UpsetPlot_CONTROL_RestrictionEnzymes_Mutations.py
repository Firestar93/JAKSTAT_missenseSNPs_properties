...
full_enzyme_mutation_map_output_path = "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\UpsetPlot_RestrictionEnzymes_Variants.tsv"

high_res_output_path = "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\UpsetPlot_RestrictionEnzymes_Variants.png"


# Define file paths
file_paths = {
    "STAT3": "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\STAT3.tsv",
    "STAT4": "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\STAT4.tsv",
    "STAT5B": "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\STAT5B.tsv",
    "JAK2": "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\JAK2.tsv",
    "JAK3": "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\JAK3.tsv",
    "TYK2": "C:\\Users\\hoffmannmd\\OneDrive - National Institutes of Health\\00_PROJECTS\\STAT_JAK_HKs_paper_request\\NucleotideSequence\\EnzymeCuts\\PythonOutput\\BenignAnalysis\\EnzymeOutput\\enzyme_analysis_output\\TYK2.tsv"
}
...
for gene, path in file_paths.items():
    ...
    if "Enzyme" in df.columns:
        mutation_columns = [col for col in df.columns if col not in ["Enzyme", "Recognition"]]  # Identify mutation-related columns
        ...
        for _, row in df.iterrows():
            ...
            if pd.notna(enzyme):  # Ensure enzyme is valid
                ...
                for mutation in mutation_columns:
                    ...
                    if pd.notna(row[mutation]) and row[mutation] not in ["-", ""]:
...
top_20_enzyme_sites = enzyme_counts_df.head(25)
...
plt.suptitle("25 Most Frequently Hit Enzyme Restriction\nSites Across Mutations", fontsize=20)
